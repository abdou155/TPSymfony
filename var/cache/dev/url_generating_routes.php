...
return [
    ...
    'test1' => [[], ['_controller' => 'App\\Controller\\TestController::test1'], [], [['text', '/test1']], [], []],
    'test2' => [['prenom', 'nom'], ['_controller' => 'App\\Controller\\TestController::test2'], [], [['variable', '/', '[^/]++', 'nom', true], ['variable', '/', '[^/]++', 'prenom', true], ['text', '/test2']], [], []],

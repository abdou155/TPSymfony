...
return [
    ...
    [ // $staticRoutes
        ...
        '/test1' => [[['_route' => 'test1', '_controller' => 'App\\Controller\\TestController::test1'], null, null, null, false, false, null]],
    ],
    [ // $regexpList
        0 => '{^(?'
                .'|/_(?'
    ...
    [ // $dynamicRoutes
        ...
        192 => [
            [['_route' => 'test2', '_controller' => 'App\\Controller\\TestController::test2'], ['prenom', 'nom'], null, null, false, true, null],
